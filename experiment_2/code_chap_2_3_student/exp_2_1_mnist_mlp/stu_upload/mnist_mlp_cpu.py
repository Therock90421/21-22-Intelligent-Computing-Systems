...
class MNIST_MLP(object):
    ...
    #def __init__(self, batch_size=100, input_size=784, hidden1=48, hidden2=24, out_classes=10, lr=0.01, max_epoch=1, print_iter=100):
    ...
    def train(self):
        ...
        for idx_epoch in range(self.max_epoch):
            self.shuffle_data()
            if idx_epoch == (self.max_epoch / 2):
                self.lr = self.lr / 2
                print(self.lr)
            if idx_epoch == (3 * self.max_epoch / 4):
                self.lr = self.lr / 2
                print(self.lr)
